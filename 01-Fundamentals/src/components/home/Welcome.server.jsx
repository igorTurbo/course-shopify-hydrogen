...
function CallToAction({url, label}) {
  return (
    <a
      href={url}
      target="_self"
      className="py-2 px-5 border border-white rounded-full inline-flex items-center hover:bg-black hover:border-black"
      rel="noreferrer"
    >
      {label}
    </a>
    ...
    <div className="banner-home text-white p-32 md:p-32 px-4 xl:px-12">
      <div className="text-center">
        ...
        <p className="text-lg mb-8">
          Explore the latest fashion trends that suit every woman and every
          occasion here and now with us.
        </p>
