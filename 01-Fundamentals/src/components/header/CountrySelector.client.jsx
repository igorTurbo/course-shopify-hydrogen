          ...
          return (
            <>
              ...
              <Listbox.Options className="absolute z-10 mt-2">
                <div className="bg-white p-4 rounded-lg drop-shadow-2xl text-primary overflow-y-auto h-64">
                  <Listbox.Option
                    disabled
                    className="p-2 color-primary text-md text-left font-medium uppercase font-bold"
                  >
                    Country
                  </Listbox.Option>
                  {!countries.length ? (
...
export function ArrowIconMobile({isOpen}) {
  return (
    <svg
      className={`transition-transform duration-300 ${
        isOpen ? 'rotate-180' : null
